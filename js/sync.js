window.dao = {
	...
	newEVent : function(event,toltes,callback) {
		var id;
		this.db.transaction(function(tx) {

			var sql = "INSERT OR REPLACE INTO events (feltoltve,albumId,eventMessage,eventMilestone,eventImg1,eventImg2,eventImg3,eventImg4,eventImg5,eventImg6,eventImg7,eventImg8,eventImg9,eventImg10,eventDate) " + "VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
			var e = event;
			var params = [toltes,e.albumid,e.eventMessage,e.eventMilestone,e.eventImg1,e.eventImg2,e.eventImg3,e.eventImg4,e.eventImg5,e.eventImg6,e.eventImg7,e.eventImg8,e.eventImg9,e.eventImg10,e.eventDate];
